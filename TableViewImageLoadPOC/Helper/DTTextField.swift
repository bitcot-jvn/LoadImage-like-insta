...
public class DTTextField: UITextField {
    ...
    public var dtborderStyle:DTBorderStyle = .rounded{
        didSet{
            ...
            case .rounded:
                dtLayer.cornerRadius        = 0.0//4.5
                dtLayer.borderWidth         = 0.0//0.5
    ...
    fileprivate func commonInit() {
        ...
        floatPlaceholderColor       = UIColor.hexStringToUIColor(.white)//UIColor.hexStringToUIColor(AppColor.PinkLight)//UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0)
        floatPlaceholderActiveColor = tintColor //UIColor.hexStringToUIColor(AppColor.PinkLight)
